...
<body>
	...
	<div class="htmleaf-container">
        ...
        <div>&nbsp;</div>
        <form class="layui-form xbs" action="/project/operationlog/giveparams2Page1">
            <div class="layui-form-pane" style="text-align: center;">
				...
				<table class="layui-hide" id="LAY_operation_log" lay-filter="operationlog"></table>
...
<script>
    ...
    layui.use('table', function () {
        ...
        //方法级渲染
        table.render({
            elem: '#LAY_operation_log'
            , url: '/project/operationlog/getOperationLogPager'
            , cols: [[
                ...
                ,{field:'systemMod',align:'center', width:230, title: '系统模块'}
                , {field: 'operation', align: 'center', title: '具体操作', width: 210},
