...
<div class="htmleaf-container" >
	...
	<div class="related" style="float: right ;width: 1300px ; height: 760px ;background-color: #74777b  ">
		<div style="width: 800px;height: 600px;position: relative;left: 20%">
			...
			<button class="layui-btn layui-btn-primary layui-btn-lg" style="width: 150px" onclick="window.location.href='frontEndUserSystem.html'">提交</button>      <button class="layui-btn layui-btn-primary layui-btn-lg" style="width: 150px" onclick="window.location.href='LoginAdmin.ftl'">返回</button>
			<button class="layui-btn layui-btn-primary layui-btn-lg" style="width: 150px" onclick="window.location.href='changepwd.html'">修改密码</button>
		</div>
